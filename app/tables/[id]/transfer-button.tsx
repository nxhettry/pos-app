...
export function TransferOrderButton({
  sourceTableId,
}: TransferOrderButtonProps) {
  ...
  const handleTransfer = async () => {
    ...
    try {
      ...
      toast.error("Failed to transfer order. Please try again.");
      console.error(err);
      setError("Failed to transfer order. Please try again.");
    } finally {
      ...
      {showTransferModal && (
        <div className="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg shadow-lg p-6 min-w-[320px]">
            <h2 className="text-lg font-semibold mb-4">Transfer Order</h2>
      ...
      {showConfirm && (
        <div className="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg shadow-lg p-6 min-w-[320px]">
            ...
            <p className="mb-4">
              Are you sure you want to transfer this order to{" "}
